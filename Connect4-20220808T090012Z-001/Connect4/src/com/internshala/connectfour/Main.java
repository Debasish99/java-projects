...
public class Main extends Application {
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Debasish Lenka");
        alert.setContentText("I love to play around codes." +
                " I am a beginner but i will be pro soon" +
                " and develop more interesting games like this." +
